...
df_recommender_test = pd.DataFrame({"user_id": user_id, "previous_interactions":previous_interactions, "recommended_book_name":recommended_book_name, "turns": turns, "recommend_indexes":recommend_indexes})
...
df_recommender_test['recommended_book_name'] = df_recommender_test['recommended_book_name'].str.lower()
...
for _, row in df_recommender_test.iterrows():
    if row["previous_interactions"] is not None:
        ...
        items_test.append(RecommenderItem(prompt, '<|sep|>' + row["recommended_book_name"] + eos))
