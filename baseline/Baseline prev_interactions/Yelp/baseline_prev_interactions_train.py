...
df_recommender_train = pd.DataFrame({"user_id": user_id, "previous_interactions":previous_interactions, "recommended_place_name":recommended_place_name, "turns": turns, "recommend_indexes":recommend_indexes})
...
print(len(recommended_place_name))
print(len(recommend_indexes))
df_recommender_validation = pd.DataFrame({"user_id": user_id, "previous_interactions":previous_interactions, "recommended_place_name":recommended_place_name, "turns": turns, "recommend_indexes":recommend_indexes})
...
df_recommender_train['recommended_place_name'] = df_recommender_train['recommended_place_name'].str.lower()
...
df_recommender_validation['recommended_place_name'] = df_recommender_validation['recommended_place_name'].str.lower()
...
for _, row in df_recommender_train.iterrows():
    if row["previous_interactions"] is not None:
        ...
        prompt = bos + "None"
    items_train.append(RecommenderItem(prompt, row["recommended_place_name"] + eos))
...
for _, row in df_recommender_validation.iterrows():
    if row["previous_interactions"] is not None:
        ...
        prompt = bos + "None"
    items_validation.append(RecommenderItem(prompt, row["recommended_place_name"] + eos))
