...
train_raw = pd.read_json("datasets/amazon_fashion/train.jsonl", lines=True)
valid_raw = pd.read_json("datasets/amazon_fashion/val.jsonl", lines=True)
...
test_raw = pd.read_json("datasets/amazon_fashion/test.jsonl", lines=True)
...
apps_training_path = "datasets/amazon_fashion/item_info.csv"
