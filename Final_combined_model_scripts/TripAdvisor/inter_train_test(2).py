...
train_raw = pd.read_json("datasets/tripadvisor/train.jsonl", lines=True)
valid_raw = pd.read_json("datasets/tripadvisor/val.jsonl", lines=True)
...
test_raw = pd.read_json("datasets/tripadvisor/test.jsonl", lines=True)
...
apps_training_path = "datasets/tripadvisor/item_info.csv"
