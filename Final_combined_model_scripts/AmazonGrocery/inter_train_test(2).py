...
train_raw = pd.read_json("datasets/amazon_grocery/train.jsonl", lines=True)
valid_raw = pd.read_json("datasets/amazon_grocery/val.jsonl", lines=True)
...
test_raw = pd.read_json("datasets/amazon_grocery/test.jsonl", lines=True)
...
apps_training_path = "datasets/amazon_grocery/item_info.csv"
